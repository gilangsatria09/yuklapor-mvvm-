 ...
 */
class DiprosesFragment : Fragment(), DaftarLaporanInterface {
    ...
    override fun onCreateView(
        ...
        val binding: FragmentDiprosesBinding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_diproses, container, false)
