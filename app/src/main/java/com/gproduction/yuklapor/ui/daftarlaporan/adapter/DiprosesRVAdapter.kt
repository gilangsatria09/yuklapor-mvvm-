...
class DiprosesRVAdapter(private val listLaporan:ArrayList<LaporkanModel>, private val viewModel: DaftarLaporanViewModel)
    :RecyclerView.Adapter<DiprosesRVAdapter.ViewHolder>() {
